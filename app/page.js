...
import mantenimiento from '@/public/icons/mantenimiento.svg'

export default function Home() {
  return (

    <main className="bg-primary w-[100vw] h-[100vh] flex items-center justify-center">
    
  
      <Image src={mantenimiento} alt='Icono de mantenimiento' className=" mr-2" />
      <h1 className="text-2xl md:text-5xl text-secondary">Sitio en mantenimiento</h1>
