                ...
                <div className='flex flex-col justify-center lg:w-1/2 w-full'>
                    ...
                    <div>
                        ...
                        <div className='text-center py-4'>
                            <a href={'https://wa.link/ifl5gf'} target='_blank' ><button className='rounded-full px-6 py-2 bg-secondary border-secondary border-2 text-primary font-assistant text-lg font-semibold hover:bg-transparent hover:text-secondary ease-in duration-300'>Cotizar ahora</button></a>
                        </div>
                    </div>
                </div>
