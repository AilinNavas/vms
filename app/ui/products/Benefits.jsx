          ...
          <div key={id} className={` flex flex-col items-center lg:flex-row ${id % 2 !== 0 ? 'lg:flex-row-reverse' : ''} lg:justify-between`}>
            ...
            <div className={` mt-4 lg:mt-0 lg:w-2/3 space-y-4 ${id % 2 === 0 ? 'lg:pl-8' : ''} lg:pr-8`}>
              ...
              <div className='text-center'>
                <a href={'https://wa.link/la8w0v'} target='_blank'  rel="noopener noreferrer"><button className="rounded-full px-6 py-2 bg-secondary border-secondary border-2 text-primary font-assistant text-lg font-semibold z-0 mt-6 lg:mt-10 hover:bg-transparent hover:text-secondary ease-in duration-300">Obtener una asesoría personalizada</button></a>
              </div>
            </div>
          </div>
        ))}
