...
//         <div className="absolute inset-0 z-20 before:absolute before:left-0 before:top-0 before:w-1/4 before:h-full before:bg-gradient-to-r before:from-gray before:to-transparent before:filter before:blur-3 after:absolute after:right-0 after:top-0 after:w-1/4 after:h-full after:bg-gradient-to-l after:from-gray after:to-transparent after:filter after:blur-3"></div> 
...
//               <div key={index} className="flex-shrink-0 h-[200px] border-2" style={{ width: `${100 / slides.length}%` }}>
