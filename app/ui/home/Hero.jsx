    ...
    return (
        ...
        <div className='relative py-16 md:py-40'>
            ...
            <div className="px-4 max-w-7xl flex flex-col space-y-2 md:space-y-0 md:flex-row md:space-x-2 mx-auto mt-4">
              <button className="rounded-full px-6 py-2 bg-primary border-2 border-primary text-secondary font-assistant text-lg font-semibold z-0 hover:bg-transparent hover:text-primary ease-in duration-300">Cotizar ahora</button>
              <button className="rounded-full px-6 py-2 border-2 border-primary text-primary font-assistant text-lg font-bold hover:bg-secondary hover:text-primary hover:border-secondary ease-in duration-300">Ver proyectos</button>
