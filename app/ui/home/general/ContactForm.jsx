...
//       <div className='max-w-7xl py-8 mx-auto px-4 bg-secondary rounded-lg shadow-lg'>
//         <h2 className='text-3xl md:text-5xl font-arapey text-center text-primary mb-6'>
//           Cotizá tu cortinado VMS
//         </h2>
...
//               </option>
//               <option value='Cortina tradicional con barral'>
//                 Tradicional con barral
//               </option>
//               <option value='Cortina tradicional con riel europeo'>
//                 Tradicional con riel europeo
//               </option>
//               <option value='Cortina roller'>Roller</option>
//               <option value='Bandas verticales'>Bandas verticales</option>
//               <option value='Toldos verticales'>Toldos verticales</option>
//               <option value='Otras'>Otras</option>
//             </select>
//           </div>
//           <div>
//             <label className='block text-primary text-xl '>
//               Tipo de tela (opcional)
//             </label>
//             <input
//               type='text'
//               name='fabricType'
