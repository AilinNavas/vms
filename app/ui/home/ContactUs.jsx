...
const ContactUs = () => {
  return (
    <div id="contacto" className='py-16 bg-secondary font-assistant text-primary text-lg lg:text-xl'>
      <div className="px-4 max-w-7xl mx-auto">
        ...
        <div className="text-center">
            <button className="rounded-full px-6 py-2 bg-primary border-2 border-primary text-secondary font-assistant text-lg font-semibold z-0 hover:bg-transparent hover:text-primary ease-in duration-300">Contactar ahora</button>
