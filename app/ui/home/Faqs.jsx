  ...
  return (
    <section id={id} className="bg-primary py-16">
      <div className='max-w-7xl px-4 mx-auto lg:px-0'>
        ...
        <a href={'https://wa.link/ifl5gf'} target='_blank'  rel="noopener noreferrer" ><button className="rounded-full px-6 py-2 bg-secondary border-2 border-secondary text-primary font-assistant text-lg font-semibold z-0 hover:bg-transparent hover:text-secondary ease-in duration-300">Obtener una asesoria personalizada</button></a>
        </div>
